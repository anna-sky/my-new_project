$(document).ready(function(){
	...
	// $(".gallery-item").eq(1).bind("click", function(e) {
	// 		e.preventDefault();
 //  		slider.reloadSlider();
 //      $(".slider-item1 img").attr("src","img/41.png");
 //      $(".slider-item2 img").attr("src","img/40.png");
 //      $('.slider-item1 .description').text('Какой-то текст 1');
 //      $('.slider-item2 .description').text('Какой-то текст 2');
	// });
	$(".gallery-item").eq(0).bind("click", function(e) {
			e.preventDefault();
  		slider.reloadSlider();
      $(".slider-item:eq(1) img").attr("src","img/41.png");
      $(".slider-item:eq(2) img").attr("src","img/42.png");
      $('.slider-item:eq(1) .description').text('Описание 1-го слайда');
      $('.slider-item:eq(2) .description').text('Описание 2-го слайда');
	});
		$(".gallery-item").eq(1).bind("click", function(e) {
			e.preventDefault();
  		slider.reloadSlider();
      $(".slider-item:eq(1) img").attr("src","img/41.png");
      $(".slider-item:eq(2) img").attr("src","img/40.png");
      $('.slider-item:eq(1) .description').text('Какой-то текст 1');
      $('.slider-item:eq(2) .description').text('Какой-то текст 2');
	});
...
function itemHeight(){
	max_height=$('.news-item').first().height();
	$('.news-item').each(function(){
		height = $(this).height();
		max_height = (max_height < $(this).height()) ? height : max_height;
	});
	$('.news-item').height(max_height);
}